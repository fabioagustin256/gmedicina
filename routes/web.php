...
Route::post('historiaclinica/{personaid}/agregarlaboratorio/{clase}', 'HistoriaClinicaController@agregar_laboratorio')->name('historiaclinica.clase.agregarlaboratorio');